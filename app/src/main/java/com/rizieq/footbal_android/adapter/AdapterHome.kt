...
import com.rizieq.footbal_android.ui.home.DetailActivity
...
class AdapterHome(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            intent.putExtra(DetailActivity.INTENT_DATA_TEAM, teamData[position])
            intent.putExtra(DetailActivity.INTENT_DATA_IMAGE,imgData.getResourceId(position,-1))
